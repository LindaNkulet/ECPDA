(function ($) {
  Drupal.behaviors.ckeditorTabberVertical = {
    attach: function (context, settings) {
      // create tabbed functionality if tabs are available
      var $ckeditorTabber = $('.ckeditor-tabber-vertical');
      ...
      if($ckeditorTabber.length > 0) {
        ...
        $ckeditorTabber.each(function() {
          ...
          // create the tabs
          $(this).before('<section class="ckeditor-tabber-tabs vertical-tab ckeditor-container-index-'+containerIndex+'"><ul class="ckeditor-tabs-holder">'+tabsHTML+'</ul><div class="ckeditor-tabs-content-holder">'+tabsContentHTML+'</div></section>');
